...
```bash
git clone https://github.com/Sum01-ghb/crypto-tracker.git
cd crypto-tracker
```
...
Replace the placeholder values with your real credentials. You can get these by signing up at: [**CoinGecko API**](https://www.coingecko.com/en/api).
